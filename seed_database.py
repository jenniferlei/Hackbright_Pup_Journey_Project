...
for hike in hike_data:
    ...
    db_hike = crud_hikes.create_hike(hike_name, difficulty, leash_rule, description, features, address, area, length, parking, resources, hike_imgURL)
...
test_bookmarks_list = crud_bookmarks_lists.create_bookmarks_list("Test Bookmarks List Name", 1, [])
