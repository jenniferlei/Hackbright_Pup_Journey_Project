...
function showCheckIns(evt) {
  ...
  const checkInsPanel = document.querySelector("#homepage-check-ins-list");
  checkInsPanel.innerHTML = null;
      ...
      for (const checkIn of data.checkIns) {
        const checkInHTML =
          ...
          ((checkIn.date_started !== null &&
            `<br>Date started: ${checkIn.date_started}`) ||
            "") +
          ((checkIn.date_completed !== null &&
            `<br>Date completed: ${checkIn.date_completed}`) ||
            "") +
          ((checkIn.miles_completed !== null &&
            `<br>Miles completed: ${checkIn.miles_completed}`) ||
            "") +
          ((checkIn.total_time !== null &&
            `<br>Total time: ${checkIn.total_time} hours`) ||
            "") +
        ...
        checkInsPanel.insertAdjacentHTML("beforeend", checkInHTML);
      }
    });
}
