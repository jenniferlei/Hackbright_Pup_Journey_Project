  ...
  return (
    <div className="pet-profile row card card-body mb-3" id={id_name}>
      ...
      <div
        ...
        id={modal_edit_id}
        tabindex="-1"
        aria-labelledby={modal_edit_form_id}
        aria-hidden="true"
      >
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id={modal_edit_form_id}>
                Edit Pet Info
              </h5>
              <button
                type="button"
...
function EditPetProfile(props) {
  ...
  function EditProfile() {
    fetch("/edit-pet", {
      ...
      body: JSON.stringify({ pet_name, gender, birthday, breed, pet_imgURL }),
    }).then((response) => {
...
function AddPetProfile(props) {
  ...
  const [my_file, setMyFile] = React.useState(props.my_file);
